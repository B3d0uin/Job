  ...
  return (
      ...
      */}
       <div>
         ...
         <div
            className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:block lg:w-20 lg:overflow-y-auto lg:bg-charcoal lg:pb-4">
               ...
               {navigation.map((item) => (
                  <li key={item.name}>
                    <a
                       href={item.href}
                       className={classNames(
                          item.current ? 'bg-powder text-charcoal' : 'text-gray-400 hover:text-white hover:bg-powder/80',
